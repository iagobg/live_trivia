defmodule LiveTriviaWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {LiveTriviaWeb.Layouts, :root}
    plug :protect_from_forgery
    plug :put_secure_browser_headers
    plug LiveTriviaWeb.PlayerSession
  end
  ...
  if Application.compile_env(:live_trivia, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: LiveTriviaWeb.Telemetry
